...
const Register = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            ...
            {isRegistered && (
                <p className="text-green-500">Registration successful. Please check your email for further instructions.</p>
            )}
            {/* Add Link to Login page */}
            <Link to="/login" className="text-blue-500 hover:underline mt-4">เข้าสู่ระบบ</Link>
        </div>
    );
};
